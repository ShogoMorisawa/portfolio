...
`,
  },
  {
    ...
    body: String.raw`## 最初に見える塊に世界観を詰める
...
一定時間で引っ込む挙動も、驚かせるためだけではない。画面を読む時間帯には情報の邪魔をせず、動き出した瞬間にまた存在感を取り戻す。その切り替えが、このサイトの呼吸になっている。`,
  },
  {
    ...
    body: String.raw`## 顔らしさは脳が勝手に補完する
